...
public class Steepest2edgesRandom {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= nExperiments; i++) {
            ...
            List<Integer> randomSolution = generateSteepest2edgesRandom(nodeList, distanceMatrix, evaluator);
    ...
    private static List<Integer> generateSteepest2edgesRandom(List<Node> nodeList, int[][] distanceMatrix, Evaluator eval) {

...
public class Steepest2edgesGreedy {
    public static void main(String[] args) {
        // Args
        if (args.length != 2) {
            System.out.println("Usage: java Steepest2edgesGreedy <instance> <n_experiments>");
            return;
        }
        ...
        SolutionSaver solutionSaver = new SolutionSaver("w3_local_search", "Steepest2edgesGreedy", instance);
